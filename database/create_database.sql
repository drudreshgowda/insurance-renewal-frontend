-- =====================================================================================
-- Intelipro Insurance Policy Renewal Management System - Database Creation Script
-- =====================================================================================
-- Version: 2.0
...
('admin@intelipro.com', crypt('Admin123!', gen_salt('bf', 10)), 'System', 'Administrator', 1, 'active');
...
('Welcome Message', 'whatsapp', 'welcome', NULL, 'Welcome to Intelipro Insurance! Your policy {policy_number} is now active.', '["customer_name", "policy_number"]', 1);
...
BEGIN
    RAISE NOTICE '=====================================================================================';
    RAISE NOTICE 'Intelipro Insurance Policy Renewal Management System Database';
    ...
    RAISE NOTICE '=====================================================================================';
    RAISE NOTICE 'Default admin user: admin@intelipro.com (password: Admin123!)';
